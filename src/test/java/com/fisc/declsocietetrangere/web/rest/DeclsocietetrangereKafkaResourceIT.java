...
import com.fisc.declsocietetrangere.DeclsocietetrangereApp;
...
@SpringBootTest(classes = DeclsocietetrangereApp.class)
@DirtiesContext(classMode = DirtiesContext.ClassMode.BEFORE_CLASS)
public class DeclsocietetrangereKafkaResourceIT {
    ...
    @Autowired
    private DeclsocietetrangereKafkaProducer producer;

    @Autowired
    private DeclsocietetrangereKafkaConsumer consumer;
    ...
    @BeforeEach
    public void setup() {
        DeclsocietetrangereKafkaResource kafkaResource = new DeclsocietetrangereKafkaResource(producer);
    ...
    public void producedMessageHasBeenConsumed() throws Exception {
        restMockMvc.perform(post("/api/declsocietetrangere-kafka/publish?message=test"))
