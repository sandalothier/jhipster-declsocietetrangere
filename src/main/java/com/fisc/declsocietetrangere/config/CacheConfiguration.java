package com.fisc.declsocietetrangere.config;
...
public class CacheConfiguration implements DisposableBean {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("declsocietetrangere");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("declsocietetrangere");
        ...
        config.getMapConfigs().put("com.fisc.declsocietetrangere.domain.*", initializeDomainMapConfig(jHipsterProperties));
